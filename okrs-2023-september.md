...
* P0-GC/BP Short series of "problem statements", as tiny programs solving a "real" problem the hard way --> the easy way
  * GC: app searching for and displaying data when you _think_ the content will be in US Core
  * GC: service mapping your internal structures into US Core for a FHIR API service
  * BP: Compare implementing a small slice of SDC behavior (say, "execute FHIR REST queries driven by pre-pop extensions") on top of SDC-enabled Questionnaires with helpers or raw typescript

* P0-BP: [FHIR IG uploader](https://github.com/brianpos/UploadFIG) works everywhere
...
* P2-GC: Complete a pass of IG package export for Firely C#
  ...
  * Decide what the package contents should look like
    * P0: Define namespaces to use within pacakges and for artifacts
    * P0: Define Level 0 functionality for constants (e.g., extension URLs)
    * P1: Define Level 1 functionality for getters/setters to wrap extensions (e.g., patient.UsCoreRace)
    * P2: Define non-terminology validation against profile
  * P0: Decide what the package names, versions and publication process should look like. Examples to think through:
    * `dotnet add package Hl7.Fhir.Uv.Sdc_3_0_0`
    * `dotnet add package Hl7.Fhir.Us.Core.6.0.0`
  * Support generation with codegen
    * P1: Generate namespaces to use within pacakges and for artifacts
    * P1: Generate Level 0 functionality for constants (e.g., extension URLs)
    * P2: Generate Level 1 functionality for getters/setters to wrap extensions (e.g., patient.UsCoreRace)
    * P3: Generate non-terminology validation against profile
    * P3-BP: Experimental cut of SDC Helpers functionality  using this framework
    * PX: Experimental cut of subscription backport library using this framework
  * P3: Work with Firely to establish long-term publication + management plan for these packages

### Firely .NET SDK users have access to FHIR's "interface" system (e.g., CanonicalResource)
* P0-GC: Complete a pass of FHIR Interface support from `fhir-codegen`
...
* P0-GC: Complete refactoring of internal models to use C# record types
* P3-GC: Improve the multi-version story of code-gen
...
* P1-BP: Static Analysis Tool for FhirPath C#
    * Ability to verify: 
        * Already done: all core spec Search Parameters
        * P1: all core spec Invariants
        * P1: CLI supports passing package to trigger testing of invariants/search parameters
        * *(Note: verifier may not have full coverage of language)*
    * P2: Discuss with Firely for inclusion in the SDK
    * P5: POC inclusion in Facade/Microsoft FHIR Server
    * P5: Support scanning Quesitonnaire/SDC linkIds in expressions

## FHIR Community has access to high-quality demo environments

### Subscriptions reference stack
* P0-GC: Complete the subscriptions client page in the UI and have it deployed
    * P6-GC: Add support for 'localhost' routing
* Build and post a 'subscription topic' "on-ramp"
    * Key concepts:
        * P1-GC: For IG authors: Getting started with subscriptions / using the RI
        * For later: 
...
* Detect and reject POSTed `SubscriptionTopic`s that are invalid or not supported because of:
    * P0: Query-based triggers with unsupported modifiers
    * P0: `canFilterBy` with unsupported modifiers
    * P5: invalid fhirpath expressions (compile)
    * *(Point users to zulip to share their use case for prioritization)*
* P4-GC/BP: Topic authoring UI - integration/linkage between RI and FHIRPath Lab.
...
### FHIR Facade
* P2-BP: Keep pace with the Firely SDK releases
* P3-BP: POC Canonical Packaging IG to show support to be a downstream server
...
### FHIRPath-Lab
* P1-BP: Support to validate fhirpath expressions (using static analysis)
* P1-BP: Short video on using the FHIRPath-Lab
* P2-BP: Better support for Subscription Topic editing and testing
* P3-BP: Introduction of the co-pilot style AI
* P5-BP: Experiment with design choices to evaluate all engines at once
* P5-BP: Run the HL7 fhirpath unit test suite via the tool and view output
* P5-BP: Followup with Health Samurai and MayJuun on integrating their fhirpath engines


## FHIR community continually improves our specifications and our processes
* P1: Schedule a session to discuss quality plan for "path to R6". Brief retrospetive:
...
* P1-BP Keep PA/FHIR R6 on track (maintain low backlog)
* P1-GC Keep FHIR Infrastructure R6/Subscriptions on track (maintain low backlog)

## FHIR community offers high-quality openly licesned educational content

### Create annotated examples of HL7 specifications
* P0-BP: Extend the `SDC by Example` content
...
* P1-BP: Short video series on SDC: (4-5 clips)
...
* P1-JM Imaging specification reviewed with at least 2 PACS/network vendors
* P1-JM Connectathon scheduled for Argo Imaging participants
  * P2 Includes at least 2 imaging servers
  * P2 Includes at least 2 imaging apps
* P2-JM Deployment plan is finalized for at least 1 clinical site
* SMART App Launcher supports "associated_endpoints" discovery
   * P1-JM In the Imaging fork
   * P3-JM In the upstream project
* SMART Client JS fork supports "associated endpoints" retrievals
   * P2-JM In the Imaging fork
   * P4-JM In the upstream project

### SMART apps can write blood pressures to EHR

* P1-JM Argonaut "Write Vitals" project has launched
  * P2-JM Participants include at least 2 EHRs
  * P2 Participants include at least 2 apps
  * P3 Participants include at least 2 health systems
* P1-JM Consensus on use cases
  * P2 clinician-triggered writes
  * P2 patient-triggered writes
  * P1 record the device used
  * P3 convey external provenance (from outside provider)
  * P3 convey app used to capture data
  * P3 convey app used to submit data
